...
const AvailableDates = () => {
  ...
  <thead>
    <tr className="bg-blue-600 dark:bg-blue-900 text-white">
      <th className="p-4 border border-gray-300 dark:border-gray-700">Period</th>
      <th className="p-4 border border-gray-300 dark:border-gray-700">Nights</th>
      <th className="p-4 border border-gray-300 dark:border-gray-700">Airport</th>
      <th className="p-4 border border-gray-300 dark:border-gray-700">Price</th>
    </tr>
  </thead>
  <tbody>
    {datePrices.map((item, index) => (
      ...
      >
        <td className="p-4 border-l border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100">
          {item.period}
        </td>
        <td className="p-4 border-l border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100">
          {item.nights}
