...
const TropicalBookSlider = ({ books, settings, title }) => {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200 text-center">{title}</h1>
...
export default TropicalBookSlider;
