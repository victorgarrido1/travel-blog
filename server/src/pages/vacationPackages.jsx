...
import VacationTitlePackage from "../components/home/vacationComponents/mainTitlePackage";
  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg max-w-4xl mx-auto shadow-md">
      <Helmet>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Sen:wght@400..800&family=Lora:wght@400;700&display=swap"
          rel="stylesheet"
        />
      </Helmet>
      ...
      <div className="breadcrumb p-4 flex space-x-2 text-sm text-gray-600 dark:text-gray-400 md:flex hidden">
        ...
        <span>/</span>
        <a href="/packages" className="text-blue-500 hover:underline">
          Packages
        </a>
        <span>/</span>
    ...
    <VacationTitlePackage />
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full bg-neutral-300 dark:bg-neutral-800 font-bold py-2 px-4 rounded-md">
          <h2 className="text-black dark:text-white">
            6 Nights Airfare from $3,412 Per Person*
          </h2>
          <ul className="check text-sm text-black dark:text-white">
            <li>
              <i className="fa-solid fa-circle-check text-green-500"></i> Daily
              Buffet Breakfast
            </li>
            <li>
      ...
      <div className="mt-8 py-6 px-4 bg-blue-100 dark:bg-blue-900 rounded-lg max-w-4xl mx-auto shadow-lg">
        <h2 className="font-lora text-xl text-gray-800 dark:text-white text-center">
        Tahiti: InterContinental Bora Bora Le Moana Package
        </h2>
        <p className="text-gray-700 dark:text-gray-300 text-justify">
          The legendary island of Bora Bora offers unsurpassed beauty and scenic
          adventure. Two pristine white-sand beaches provide the perfect
          backdrop for the ultimate island escape. Our traditional bungalow
          suites are situated either on the beach or over the lagoon, allowing
          guests to seamlessly blend with the stunning natural landscape.
        </p>
      ...
      <p
        data-test="vpPackageID"
        className="disclaimer disclaimer-secondary mb-4 p-2"
      >
